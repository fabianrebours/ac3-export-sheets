...
def flatten_products(products):
    ...
    column_order = [
        ...
        "[CT] Type de bien", "[CT] Code postal", "[CT] Ville", "[CT] Dans un rayon", "[CT] Géolocalisation de la recherche",
        "[CT] Statut du bien", "[CT] Type Mandat", "[CT] Pays", "[CT] Forme Mandat", "[CN] Honoraires Acquéreur",
        "Photos", "Rooms", "Description_title", "Description_text", "Customer_nom", "Customer_email", "Customer_tel",
        "Customer_creation_date", "Customer_next_contact", "Customer_last_action", "Category_name", "Themes",
        "INSEE_code_insee", "INSEE_commune", "INSEE_arrondissement", "INSEE_secteur", "Statistic_nb_vues",
        "Statistic_nb_contacts", "Statistic_nb_visites", "Suivi_par_nom", "Suivi_par_email", "Suivi_par_tel",
        "Suivi_par_mobile", "Cree_par_nom", "Cree_par_email", "Cree_par_tel", "Cree_par_mobile",
        "[CT] Type de transaction", "[CT] Cuisine", "[CT] Type Chauffage", "[CT] Date Echéance", "[CT] Etat général",
        "[CT] Mode Chauffage", "[CT] Etat intérieur", "[CT] Fenêtres", "[CT] Adresse", "[CT] Date Mandat",
        "[CT] Type de Stationnement", "[CT] Neuf - Ancien", "[CT] Isolation", "[CT] Points forts",
        "[CT] Exposition Séjour", "[CT] Etat Communs", "[CT] Consommation énergie primaire", "[CT] Gaz Effet de Serre",
        "[CT] Date établissement Diagnostic Energétique", "[CT] C.P. ou Ville internet", "[CT] Dans un rayon web",
        "[CT] N° lot", "[CT] Nb Lots Copropriété", "[CT] Procédures diligentées c/ syndicat de copropriété",
        "[CT] Titre Fiche Commerciale", "[CT] URL Prise de RDV en ligne", "[CN] Prix", "[CN] Nombre pièces", "[CN] Surface",
        "[CN] Surface terrain", "[CN] Chambres", "[CN] Etage", "[CN] Salle(s) d'eau", "[CN] Nombre places parking",
        "[CN] Cave(s)", "[CN] Année construction", "[CN] Nombre étages", "[CN] Prix Net Vendeur", "[CN] Accès Bus",
        "[CN] Accès Ecole", "[CN] Accès RER", "[CN] WC", "[CN] N° cave", "[CN] N° parking", "[CN] Honoraires Vendeur",
        "[CN] Valeur consommation énergie primaire", "[CN] Valeur Gaz Effet de serre", "[CN] Surface loi Carrez",
        "[CN] Charges annuelles (ALUR)", "[CN] Délai publication mandat",
        "[CN] Diagnostic de performance énergétique (10 ans)", "[CN] ERP - Etat des risques et pollution (6 mois)",
        ...
        "[CN] Diagnostic parasite", "[CN] Etat de l'installation d'assainissement - Collectif (préconisations à suivre en fonction du compte rendu)",
        "[CN] Etat de l'installation d'assainissement - non collectif (préconisations à suivre en fonction du compte rendu)",
        "[CN] Autres", "[CN] Titre de propriété (complet)", "[CN] Justificatif d'identité (copie carte d'identité, passeport)",
        "[CN] Justificatif de domicile (copie facture EDF,...)", "[CN] Livret de famille", "[CN] Taxe d'habitation",
        "[CN] Taxe foncière", "[CN] Facture de consommation d'énergie (EDF, GDF,fioul...)", "[CN] La liste du mobilier et matériels divers restant (hors cuisine aménagée et équipements intégrés)",
        "[CN] Facture et/ou contrat entretien chaudière (si chauffage individuel)", "[CN] Attestation ramonage",
        ...
        "[CN] Extrait Kbis de moins de 3 mois", "[CN] Statuts de la société", "[CN] PV AG de la société",
        "[CN] Autorisation écrite du locataire pour visite", "[CN] Congé adressé par le propriétaire",
        "[CN] Congé adressé par le locataire", "[CN] Bail et avenants éventuels (si le bien est vendu loué)",
        "[CN] Attestation successorale (en cas de succession, donation, adjudication, etc ...)", "[CN] Extrait du POS ou du PLU",
        "[CN] Plan cadastral", "[CN] Attestation de déclaration de puits ou forage",
        ...
        "[CN] Certificat de conformité du réseau collectif d'assainissement", "[CN] Contrat d'affichage",
        "[CN] Déclaration d'Achèvement des Travaux (DAT)", "[CN] Déclaration de Travaux (DT)", "[CN] Facture vidange des fosses septiques",
        "[CN] Permis de construire (si résidence de - 10 ans et agrandissements ou travaux nécessitant des autorisations)",
        "[CN] Plan Maison", "[CN] Règlement et cahier des charges du lotissement",
        "[CN] Assurances constructeurs / artisans (garanties décennales)", "[CN] Adresses constructeurs/artisans",
        "[CN] Règlement de lotissements", "[CN] PV d'assemblée générales (les 3 derniers)", "[CN] DTA et fiche synthétique",
        "[CN] Convocation et ordre du jour prochaine AG (si proche de l'AG annuelle et si convocation déjà reçue)",
        "[CN] Pré Etat daté", "[CN] PV d'Assemblée Générale Extraordinaire (si décisions urgentes de travaux)",
        "[CN] Règlement de copropriété et état descriptif de division ainsi que les actes les modifiant s'ils ont été publiés",
        "[CN] Appels de Fonds trimestriels (les 4 derniers)", "[CN] Décompte des charges de copropriété (dernier décompte approuvé)",
        "[CN] PV de réception de l'appartement (si résidence de - 10 ans)", "[CN] Carnet d'entretien de l'immeuble",
        "[CN] Certificat d'urbanisme", "[CN] Matrice cadastrale", "[CN] Document d'arpentage", "[CN] Déclaration préalable",
        "[CN] Copie du permis d'aménager", "[CN] Arrêt autorisant la vente anticipée des lots", "[CN] Déclaration d'achèvement des travaux",
        "[CN] Devis comprenant le coût global de la division", "[CN] Arrêté autorisant le lotissement",
        "[CN] Dépôt de pièces du lotissement auprès du notaire", "[CN] Autorisation de cession anticipée des lots",
        "[CN] Statuts de l'association syndicale", "[CN] Règlement de lotissement", "[CN] Cahier des charges",
        "[CN] Garantie financière accordée au lotisseur pour la finition des travaux", "[CN] Plan de masse",
        "[CN] Plan de division", "[CN] Plan des réseaux", "[CN] Justificatifs de revenus (Avis d'imposition, 3 derniers bulletins de salaire",
        "[CN] Justificatifs du prêt immobilier", "[CN] Justificatifs de l'épargne", "[CN] Loyer de base", "[CN] Cotisation fonds travaux",
        "[FT] Texte Fiche Commerciale", "[CT] N° Mandat", "[CT] Construction", "[CN] Loyer mensuel HC", "[CN] Taxe Foncière",
        "[CN] Coût Energie", "[CN] Prix Estimé (Maxi)", "[CN] Prix Estimé (Mini)", "[CT] Couverture", "[CT] Etat extérieur",
        "[CT] Date Estimation", "[CN] Provision sur charges", "[CN] Charges copropriété", "[CT] Surface divisible",
        "[CT] Méca. Chauffage", "[CT] Cheminée", "[CT] Assainissement", "[CT] Syndic", "[CT] Numéro cadastre",
        "[CT] Nom section cadastrale", "[CT] Année de référence des prix de l'énergie (DPE réalisés jusqu'au 30/06/2024)",
        "[CT] Forme Toiture", "[CT] Date d'établissement Etat des Risques et Pollutions(ERP)", "[CT] Visite virtuelle privée",
        "[CN] Salle(s) de bains", "[CN] Nombre garages/Box", "[CN] Surface Jardin",
        ...
        "[FT] Désignation du bien", "[FT] Lien vidéo", "[CN] Hauteur sous plafond",
        "[CN] Estimation du coût annuel des énergies pour un usage standard (DPE réalisé avant le 01/07/2021)",
        "[CN] Quote part de charges", "[CT] Porte", "[CT] N° Digicode", "[CT] Heures de Visite", "[CT] Nom Contact",
        "[CT] Téléphone Contact", "[CT] Points faibles", "[CT] Agences autorisées", "[CT] Date dernière assemblée",
        "[CN] Accès Métro", "[FT] URL origine pige", "[CT] Tantièmes", "[CN] Surface séjour", "[CN] Surface Cave",
        "[CT] Diagnostic Perf. Numérique", "[CN] Nombre niveaux", "[CN] Surface terrasse", "[CT] Mitoyenneté",
        "[CN] Surface au sol", "[CT] Standing", "[CT] Volets", "[CT] Type Bail", "[CN] Prix de départ",
        "[CN] Loyer charges comprises", "[CT] Date premier mandat", "[CT] Organisation Diagnostics",
        "[CT] Dont lots d'habitation", "[CT] Date établissement Audit Energétique", "[CT] Dernière mise à jour",
        "[CT] Date Diagnostic Elect", "[CT] Consommation énergie finale", "[CN] Surface de référence",
        "[CN] Valeur consommation énergie finale", "[CT] Référence Affaire", "[CT] Nom Résidence", "[FT] Consignes/Itinéraires"
    ]
